      ...
      <div className="footerarea">
        <div className="container">
          ...
          <div className="footerarea__wrapper footerarea__wrapper__2">
            <div className="row">
              <div
                className="col-xl-4 col-lg-4 col-md-6 col-sm-12 aos-init aos-animate"
                data-aos="fade-up"
              >
                <div className="footerarea__inner footerarea__about__us">
                  ...
                  <div className="footerarea__content">
                    <p>
                      ...
                      chauffeured car end service in major cities across World.
                    </p>
                  </div>
              ...
              <div
                className="col-xl-2 col-lg-2 col-md-6 col-sm-6 aos-init aos-animate"
                data-aos="fade-up"
              >
              ...
              <div
                className="col-xl-3 col-lg-3 col-md-6 col-sm-6 aos-init aos-animate"
                data-aos="fade-up"
              >
              ...
              <div
                className="col-xl-3 col-lg-3 col-md-6 col-sm-12 aos-init aos-animate"
                data-aos="fade-up"
              >
            ...
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-6">
                <div className="footerarea__copyright__content footerarea__copyright__content__2">
                  <p>
                    Copyright © <span>2023</span> by edurock. All Rights
                    Reserved.
                  </p>
                </div>
              </div>
