      ...
      <div className="gridarea gridarea__2">
        <div className="container">
          ...
          >
            ...
            <div
              className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter2 filter3"
            ...
            <div
              className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter4 filter5"
            ...
            <div
              className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter4"
              style={{ position: "absolute", left: "0%", top: 495 }}
            >
              <div className="gridarea__wraper">
                <div className="gridarea__img">
                  <a href="course-details.html">
            ...
            <div
              className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter1 filter3"
              style={{ position: "absolute", left: "33.3333%", top: 495 }}
            >
              <div className="gridarea__wraper">
                <div className="gridarea__img">
                  <a href="course-details.html">
            ...
            <div
              ...
              style={{ position: "absolute", left: "66.6667%", top: 495 }}
            >
              <div className="gridarea__wraper">
                <div className="gridarea__img">
                  <a href="course-details.html">
